window.dynamicCoordinates = {
  coordinates: {
    0: {
      ...
      "Account opening date FORMATED": { coords: [ { pos: [181.10, 30.30], char_spacing: 2, font_size: 8 }
        ]
      },
  ...
  field_mapping: {
    ...
    "Account opening date FORMATED": "accountOpeningDateFormatted"
...
photo_signature: {
    ...
    signature: {
      0: [
        { x: 320.90, y: 550.70, width: 240, height: 96  },
        { x: 290.50, y: 265, width: 144, height: 15 }
      ],
      1: [
        { x: 345.17, y: 305, width: 144, height: 115 }
      ]
    },
    stamps: {
      0: [
        { file: "Sahara.png", x: 300, y: 575, width: 100, height: 100 },
      ...
      1: [
        { file: "Sahara.png", x: 270, y: 300, width: 100, height: 100 },
